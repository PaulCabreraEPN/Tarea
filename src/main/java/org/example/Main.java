...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(miFigura11.getlongitudLado());
        System.out.println("El número de lados es:");
        System.out.println(miFigura11.getNumero_lados());
        System.out.println("El perimetro es");
        System.out.println(miFigura11.calcularPerimetro());
        System.out.println("El valor de la apotema es");
        miFigura11.setApotema(20.0);
